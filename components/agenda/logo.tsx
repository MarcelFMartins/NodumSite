...
export function AgendaLogo({ className }: { className?: string }) {
  return (
    <span className={cn("group inline-flex items-center gap-2.5", className)}>
      ...
      <span className="font-display text-lg font-bold leading-none tracking-tight text-white">
        ...
        <span className="ml-0.5 font-semibold text-body">Agenda</span>
      </span>
      <span className="sr-only">Agenda Interna Nodum — gestão de tarefas e CRM</span>
    </span>
  );
}

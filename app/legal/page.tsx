...
export const metadata: Metadata = {
  title: "Termos, privacidade e contrato",
  description:
    "Os documentos que regem o uso dos produtos Nodum: Termos de Uso, Política de Privacidade (LGPD) e Contrato de Assinatura.",
